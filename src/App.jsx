...
const SHEETS = [
  ...
  { id: "1", name: "Stand For", gid: "" },
  { id: "2", name: "Laravel Sheet", gid: "" },
];
...
const App = () => {
  ...
  const sheetUrlMap = {
    0:
      process.env.REACT_APP_DAILY_TASK_SHEET_URL ||
      process.env.REACT_APP_SHEET_URL ||
      "",
    1: process.env.REACT_APP_STAND_FOR_SHEET_URL,
    2:
      process.env.REACT_APP_LARAVEL_SHEET_URL ||
      process.env.REACT_APP_SHEET_URL ||
      "",
  };
  console.log(
